...
# -------------------------------------------------------------------NOTES
# Positional arguments must always come first when calling or defining a function in Python

# -------------------------------------------------------------------FUNCTIONS
def generate_subranges(x, chunk_size):
        for i in range(0, x, chunk_size):
            yield (i, min(i + chunk_size, x))
# -------------------------------------------------------------------------------------------------------------------------------------------------------
